...
const createConsumoTC = `import { getSupabaseClient } from './_lib/supabase.js';
...
const deleteConsumoTC = `import { getSupabaseClient } from './_lib/supabase.js';
...
const updateConsumoTC = `import { getSupabaseClient } from './_lib/supabase.js';
...
fs.writeFileSync(path.join(apiDir, 'createConsumoTC.js'), createConsumoTC, 'utf8');
fs.writeFileSync(path.join(apiDir, 'updateConsumoTC.js'), updateConsumoTC, 'utf8');
fs.writeFileSync(path.join(apiDir, 'deleteConsumoTC.js'), deleteConsumoTC, 'utf8');
console.log('TC endpoints generated');
